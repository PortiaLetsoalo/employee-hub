...
namespace EmployeeHub.Migrations
{
    ...
    [Migration("20240617094911_M20240617114800")]
    partial class M20240617114800
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeHub.Domain.Addresses.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EmployeeHub.Domain.Skills.Skill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EmployeeHub.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EmployeeHub.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EmployeeHub.Domain.Persons.Person", b =>
                {
                    b.HasOne("EmployeeHub.Domain.Addresses.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeHub.Domain.Skills.Skill", b =>
                {
                    b.HasOne("EmployeeHub.Domain.Persons.Person", "Person")
                        .WithMany()
