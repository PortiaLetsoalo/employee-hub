...
{
    public abstract class EmployeeHubWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmployeeHubWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmployeeHubWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmployeeHubDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmployeeHubDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmployeeHubDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmployeeHubDbContext, Task<T>> func)
        {
            T result;
